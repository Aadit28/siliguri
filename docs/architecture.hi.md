...
इन्हीं सीमाओं की वजह से हर push एक row `alerts` (migration 13) में भी लिखता है,
चाहे कोई डिवाइस उसे पाए या नहीं। घंटी उस इनबॉक्स को लोकल reminder सूची के साथ
मिलाकर दिखाती है — web पर परिवार का अलर्ट सिर्फ़ वहीं दिखेगा। पैनल खोलते ही
इनबॉक्स पढ़ा हुआ हो जाता है; तीस दिन से पुरानी rows digest cron मिटा देता है।
